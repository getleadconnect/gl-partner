...
<head>
    ...
    <title>GetLead Channel Partner</title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <img class="brand-title" src="{{asset('frontend/image/Frame.png')}}" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
                                    <img src="{{asset('backend/images/profile/12.png')}}" width="20px" alt=""/>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class=" ai-icon" href="{{url('admin/home')}}" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text"  style="font-size: 13px">Dashboard</span>
						</a>
                    </li>
                    <li><a class="ai-icon" href="{{ url('admin/client') }}" aria-expanded="false">
						<i class="flaticon-381-television"></i>
							<span class="nav-text"  style="font-size: 13px">Clients</span>
						</a>

                    </li>
                    <li><a class="ai-icon" href="{{url('admin/project') }}" aria-expanded="false">
							<i class="flaticon-381-controls-3"></i>
							<span class="nav-text"  style="font-size: 13px">Projects</span>
						</a>

                    </li>
                      <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-notepad"></i>
							<span class="nav-text" style="font-size: 13px">Business Account </span>
						</a>
                        <ul aria-expanded="false">
                        	 <li><a href="{{ url('admin/channel-partner')}}"  style="font-size: 13px">Channel Partner</a></li>
                            <li><a href="{{ url('admin/business-registration')}}"  style="font-size: 13px">Registered user</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text" style="font-size: 13px" >Settings</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{ url('admin/projecttype')}}"  style="font-size: 13px">Project Types</a></li>
                            <li><a href="{{ url('admin/business-category')}}"  style="font-size: 13px">Business category</a></li>
                            <li><a href="{{ url('admin/projectowner')}}" style="font-size: 13px">Project Owner</a></li>
                            <li><a href="{{ url('admin/projectstatus')}}"  style="font-size: 13px">Project Status</a></li>
                            <!-- <li><a href="{{ url('admin/settings/account')}}">Account settings</a></li> -->
                            <!-- <li><a href="{{ url('admin/settings/contact')}}">Contact US</a></li> -->
                ...
                {{-- //*footer text start --}}
				{{-- <div class="copyright">
					<p class="fs-14 font-w200"><strong class="font-w400">GetLead </strong> © 2020 All Rights Reserved</p>
					<p>Made with <i class="fa fa-heart"></i>GetLead</p>
				</div> --}}
                {{-- //*footer text End --}}
			</div>
        </div>
