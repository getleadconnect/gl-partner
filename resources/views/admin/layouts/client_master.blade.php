                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
                                    <img src="{{asset('backend/images/profile/12.png')}}" width="20" alt=""/>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="{{url('partner/dashboard')}}" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text"  style="font-size: 13px">Dashboard</span>
						</a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{ url('partner/client') }}" aria-expanded="false">
