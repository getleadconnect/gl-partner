...
@section('content')
	...
	@include('admin.pages.partials.breadcrumb',['title'=>'Notification','subtitle'=>''])
								...
								<div class="tab-pane active" id="kt_widget6_tab1_content" aria-expanded="true">
									<div class="kt-notification">
										<a href="#" class="kt-notification__item">
											...
											<div class="kt-notification__item-details" onclick="toggle('notification-details-1')">
												...
												<div class="kt-notification__item-time " id="notification-details-1" style="display:none">
													2 hrs adsfasdgo
												</div>
											</div>
