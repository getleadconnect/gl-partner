   ...
   <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success"  href="{{ url('admin/faqs-category/create') }}"> Create New FAQ Category</a>
            </div>
        </div>
    </div>
...
@else
 ...
 -->    
                    <a class="btn btn-primary" href="{{ url('admin/faqs-category/edit',$data->id) }}">Edit</a>
       </td> 
      </tr>
     @endforeach
    </tbody>
