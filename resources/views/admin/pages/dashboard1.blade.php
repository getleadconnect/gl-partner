  ...
  <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 mb-md-4 align-items-start">
					<div class="mr-auto d-none d-lg-block display-flex">
						<h3 class="text-black font-w600 text-center">Welcome to GetLead Channel Partner!</h3>
         ...
         $client = DB::table('users')->where('role_id',1)->count();
          $aprtner = DB::table('users')->where('role_id',2)->count();
         @endphp
					...
					<div class="col-xl-3 col-xxl-6 col-sm-6">
						...
						<a href="{{ url('admin/channel-partner')}}">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body">
										<p class="mb-1">Total channel partner</p>
										<div class="d-flex flex-wrap">
											<h2 class="fs-40 font-w600 text-white mb-0 mr-3">{{$aprtner}}</h2>
