...
@section('content')
	...
	@include('admin.pages.partials.breadcrumb',['title'=>'Privacy & Policy Settings','subtitle'=>'Edit Privacy & Policy details'])
      ...
      @endif
				<div class="kt-portlet__body">
					<form class="kt-form kt-form--fit kt-form--label-right" action="{{ url('admin/privacy-policy') }}" method="post"  enctype="multipart/form-data">
                                {{ csrf_field() }}
											...
											<div class="kt-section__body">
												<div class="row">
													...
													<div class="col-lg-9 col-xl-6">
														<h3 class="kt-section__title kt-section__title-sm">Privacy & Policy:</h3>
													</div>
												</div>
												
												<div class="form-group row">
													<label class="col-xl-3 col-lg-3 col-form-label">Privacy & Policy</label>
													<div class="col-lg-9 col-xl-6">
